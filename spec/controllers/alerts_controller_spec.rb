  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved alert as @alert" do
        ...
        post :create, {:alert => { "vehicle_id" => "invalid value" }}, valid_session
        assigns(:alert).should be_a_new(Alert)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested alert" do
        ...
        Alert.any_instance.should_receive(:update_attributes).with({ "vehicle_id" => "1" })
        put :update, {:id => alert.to_param, :alert => { "vehicle_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the alert as @alert" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Alert.any_instance.stub(:save).and_return(false)
        put :update, {:id => alert.to_param, :alert => { "vehicle_id" => "invalid value" }}, valid_session
        assigns(:alert).should eq(alert)
      end
