  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested message" do
        ...
        Message.any_instance.should_receive(:update_attributes).with({ "from" => "1" })
        put :update, {:id => message.to_param, :message => { "from" => "1" }}, valid_session
      end
